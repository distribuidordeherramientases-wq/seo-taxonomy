...
final class SEO_Dependiente_Admin {
    ...
    public static function render_page() {
        ...
        <div class="wrap seo-dependiente-admin">
            <h1>Dependiente</h1>
            <p class="description">Búsqueda guiada, aprendizaje supervisado y observabilidad del asistente comercial.</p>
            ...
            <nav class="nav-tab-wrapper seo-dependiente-admin__tabs" aria-label="Secciones de Dependiente">
                ...
                <?php self::render_tab_link('diagnostic', 'Diagnóstico', $tab); ?>
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">Puedes usar las imágenes incluidas en el módulo o subir las tuyas a Medios y seleccionarlas aquí.</p>
                            </td>
                        </tr>
                        <tr>
            ...
            <div>
                ...
                <div class="postbox seo-dependiente-admin__box">
                    ...
                    <ol class="seo-dependiente-admin__steps">
                        ...
                        <li>Busca en campos comerciales y vocabulario semántico.</li>
                        <li>Explica por qué encaja cada producto.</li>
                        <li>Permite afinar por filtros técnicos.</li>
                        <li>Registra interacciones para aprendizaje supervisado.</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    private static function render_diagnostic_tab() {
        ...
        <div class="seo-dependiente-admin__toolbar-row">
            ...
            <a class="button button-primary" href="<?php echo esc_url($export_url); ?>">Exportar diagnóstico JSON</a>
        </div>

        <div class="seo-dependiente-admin__metrics">
            <?php self::metric('Búsquedas', $summary['searches'] ?? 0); ?>
            ...
            <?php self::metric('Aclaraciones mostradas', $summary['clarifications_shown'] ?? 0); ?>
        ...
        <section class="postbox seo-dependiente-admin__box seo-dependiente-admin__wide-box">
            <h2 class="seo-dependiente-admin__box-title">Últimas búsquedas</h2>
    ...
    private static function render_recent_table($rows) {
        ...
        <div class="seo-dependiente-admin__table-wrap"><table class="widefat striped seo-dependiente-admin__search-table">
            <thead><tr><th>Consulta</th><th>Interpretación</th><th>Estrategia</th><th>Resultados</th><th>Interacción</th><th>Aprendizaje</th><th>Fecha</th></tr></thead>
            <tbody>
            <?php foreach ((array) $rows as $row) :
                ...
                if (!empty($row['clicked_product_id'])) {
                ...
                <tr>
                    ...
                    <td><?php echo esc_html(number_format_i18n(absint($row['result_count'] ?? 0))); ?></td>
