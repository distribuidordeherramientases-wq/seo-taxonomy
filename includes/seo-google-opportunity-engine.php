...
function seo_google_opportunity_render_sources(array $payload, $days) {
    seo_google_opportunity_render_header(
        ...
        'Estado operativo de cada fuente y acceso a los informes técnicos. Las conexiones existentes de Search Console y Analytics se mantienen sin cambios.',
        $days,
        'sources'
    );
    seo_google_opportunity_render_source_cards($payload['sources']);
    ...
    $links = array(
        ...
        'Sincronización'             => 'sync',
        'Configuración Search Console'=> 'settings',
    );
