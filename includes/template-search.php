...
/*
 * Las busquedas de producto usan la plantilla de busqueda y el motor SEO Search.
 * No cargan template-shop.php ni ninguno de sus bloques comerciales.
 */
if (
    $is_product_search
    && $search_term !== ''
    ...
    <section class="dht-section">
        <div class="dht-container">
            <div class="dht-section-header dht-section-header--left">
                <span class="dht-kicker">Busqueda</span>
            ...
            <?php else : ?>
                <div class="dht-empty-state">
                    ...
                    <p>Prueba con terminos mas generales o consulta el catalogo completo.</p>
