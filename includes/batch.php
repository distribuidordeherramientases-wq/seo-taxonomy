...
function seo_ie_batch_product_options( $header = [] ) {
    ...
    return [
        ...
        /*
         * La cola automatica se usa principalmente para actualizaciones de
         * clasificacion/enriquecimiento. Aunque el CSV completo incluya SKU,
         * no debe reescribir el identificador de un producto ya existente.
         */
        'update_sku'     => false,
        'dry_run'        => false,
    ];
    ...
    $state    = [
        ...
        'log'                  => [
            ...
            'detalles'     => [
                ...
                'En actualizaciones por cola se conserva el SKU existente. El valor legacy «0» se interpreta como SKU vacío y nunca se usa como identificador.',
            ],
        ],
    ];
