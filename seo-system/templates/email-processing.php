...
<div class="dht-email dht-email--processing">
    <div class="dht-email-status">
        <span class="dht-email-kicker">Pedido recibido</span>
        ...
        <p>
            <?php
            printf(
                esc_html('Hemos recibido tu pedido #%s y ya lo estamos preparando.'),
        ...
        <p class="dht-email-muted">
            Te avisaremos cuando el pedido cambie de estado.
        </p>
    </div>
