...
.dht-page-product-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:18px!important}
...
.dht-page-related-cat-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:18px!important}
...
while (have_posts()) :
    ...
    <article <?php post_class('dht-post dht-page dht-page--conversion dht-mobile-template'); ?>>
